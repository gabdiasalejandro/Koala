...
La construccion de layouts concretos vive en cada document type. Este modulo
solo ofrece helpers compartidos para settings y para ensamblar el contexto final.
"""
...
class RenderSettingsResolver:
    """Resuelve settings visuales compartidos con precedencia uniforme."""
...
class RenderContextBuilder:
    """Ensambla un `RenderContext` desde una escena ya calculada."""
    ...
    def build(
        ...
        *,
        ...
        viewport = ViewportFitter.fit(scene, settings.layout_kind, settings.layout_config)
