"""Motor de layout tipo cuadro sinoptico con recuadros.
...
def compute_synoptic_box_subtree_heights(
    node: ConceptNode,
    boxes: Dict[str, LayoutBox],
    config: LayoutConfig,
    ...
    child_heights = [compute_synoptic_box_subtree_heights(child, boxes, config, subtree_heights) for child in node.children]
...
def assign_synoptic_box_positions(
    root_nodes: List[ConceptNode],
    boxes: Dict[str, LayoutBox],
    config: LayoutConfig,
    subtree_heights: Dict[str, float],
...
def build_synoptic_boxes_layout(
    root_nodes: List[ConceptNode],
    config: LayoutConfig,
    ...
    edges = build_synoptic_box_edges(root_nodes, boxes, config)
